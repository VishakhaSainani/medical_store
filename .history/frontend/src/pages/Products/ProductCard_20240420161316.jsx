...
const ProductCard = ({ p }) => {
  ...
  return (
    <div className="max-w-sm relative bg-[#094d45] rounded-lg shaodw dark:bg-gray-800 dark:border-gray-700 hover:drop-shadow-xl">
      ...
      <div className="p-5">
        <div className="flex justify-between">
          ...
          <p className="text-black font-semibold text-cyan-500">
        ...
        <p className="mb-3 font-normal text-[#4b4a4a]">
